...
@property (nonatomic,assign,getter = isTorchOn) BOOL torchOn; // 是否打开闪光灯

@property(nonatomic,strong)UIImageView *guohuiImageView;//国徽
@property(nonatomic,strong)UIImageView *idCardFrontImageView;//身份证正面（人头）
@property(nonatomic,strong)UIImageView *carCardImageView;//驾照
@end
